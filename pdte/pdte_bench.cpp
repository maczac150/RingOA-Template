...
void Pdte_Offline_Bench(const osuCrypto::CLP &cmd) {
    ...
    Logger::InfoLog(LOC, "Pdte Offline Benchmark started (repeat=" + ToString(repeat) + ")");
    ...
    Logger::InfoLog(LOC, "Pdte Offline Benchmark completed");
    Logger::ExportLogListAndClear(kLogRingOaPath + "pdte_offline_bench", /*use_timestamp=*/true);
}
...
void Pdte_Online_Bench(const osuCrypto::CLP &cmd) {
    ...
    Logger::InfoLog(LOC, "Pdte Online Benchmark started (repeat=" + ToString(repeat) +
    ...
    Logger::InfoLog(LOC, "Pdte Online Benchmark completed");
    Logger::ExportLogListAndClear(kLogRingOaPath + "pdte_online_p" + ToString(party_id) + "_" + network, /*use_timestamp=*/true);
}
